<div>
    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <div class="mt-8 text-2xl">
            Welcome to your PABLO Custom Edition application!
        </div>
        ...
        <div class="mt-6 text-gray-500">
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg padding-five">
                        <div class="flex">
                                ...
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="p-3 px-5">
                                        ...
                                        <form action="/task/{{$task->id}}" class="inline-block">
                                            <button type="submit" name="delete" formmethod="POST" class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline" onclick="if (!confirm('Are you sure?')) return false;">Delete</button>
                                            {{ csrf_field() }}
                                        </form>
                                    </td>
                                </tr>
